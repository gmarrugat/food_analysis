...
def load_parameters():
    ...
    ALL_MODELS = [
                        ...
                        'MODELS_ROOT_PATH': 'models/Ontology_1_-1/',
                        'EVALUATE': True,
                        # Dataset params
                        ...
                        'ONTOLOGY': '/media/HDD3TB/gerard/food_analysis-dag_labels/datasets/Recipes5k/mtannotations/Ontologies_1_-1/DI_ID_ontology_matrix.npy',
                        'INPUTS': {'images': {
                                            'type': 'raw-image',
