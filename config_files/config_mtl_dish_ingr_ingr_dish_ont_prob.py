...
def load_parameters():
    ...
    ALL_MODELS = [
                        ...
                        'MODELS_ROOT_PATH': 'models/Ontology_probabilities/',
                        'EVALUATE': True,
                        # Dataset params
                        ...
                        'ONTOLOGY': '/media/HDD3TB/gerard/food_analysis-dag_labels/datasets/Recipes5k/mtannotations/Ontologies_probabilities/DI_ID_ontology_matrix.npy',
                        'INPUTS': {'images': {
                                            'type': 'raw-image',
