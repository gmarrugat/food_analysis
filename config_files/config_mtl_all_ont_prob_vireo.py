...
def load_parameters():
    ...
    ALL_MODELS = [
                        ...
                        'MODELS_ROOT_PATH': 'models/Ontology_probabilities_VIREO/Ontology_1',
                        'EVALUATE': True,
                        # Dataset params
                        'DATA_ROOT_PATH': '/home/eduardo/Documents/datasets/VireoFood172/',
                        'DATASET_NAME': 'Food_Multitask',
                        'REBUILD_DATASET': False,
                        'ONTOLOGY': '/media/HDD3TB/gerard/food_analysis-dag_labels/datasets/VireoFood172/meta/ontology_files/Ontologies_1/DI_ontology_matrix.npy',
                        'INPUTS': {'images': {
                                            'type': 'raw-image',
                                            'path': 'meta/%s_2.txt',
                                            'img_size': [342, 342, 3],
