...
def load_parameters():
    ...
    ALL_MODELS = [
                        ...
                        {
                        # Model params
                        'MODEL_TYPE': 'InceptionResNetV2_Multitask_Two_Ont', # see predefined models in models.py
                        'MODEL_NAME': 'Food_multitask',
                        'STORE_PATH': '%s/food_multitask_dish_ingr_ingr_ingr_ont', # insert MODELS_ROOT_PATH in %s
                        'MODELS_ROOT_PATH': 'models/Ontology_probabilities_VIREO/Two_Ontology_prob_neg',
                        'EVALUATE': True,
                        # Dataset params
                        'DATA_ROOT_PATH': '/media/HDD3TB/gerard/food_analysis-dag_labels/datasets/VireoFood172/',
                        'DATASET_NAME': 'Food_Multitask',
                        'REBUILD_DATASET': False,
                        'ONTOLOGY': '/media/HDD3TB/gerard/food_analysis-dag_labels/datasets/VireoFood172/meta/ontology_files/Ontologies_prob_neg/DI_II_ontology_matrix.npy',
                        'INPUTS': {'images': {
                                            'type': 'raw-image',
                                            'path': 'meta/%s_2.txt',
                                            'img_size': [342, 342, 3],
