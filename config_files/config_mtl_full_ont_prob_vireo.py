...
def load_parameters():
    ...
    ALL_MODELS = [
                        ...
                        'STORE_PATH': '%s/food_multitask_full_ont', # insert MODELS_ROOT_PATH in %s
                        ...
                        'ONTOLOGY': '/media/HDD3TB/gerard/food_analysis-dag_labels/datasets/VireoFood172/meta/ontology_files/Ontologies_prob/FULL_ontology_matrix.npy',
                        'INPUTS': {'images': {
                                            'type': 'raw-image',
                                            'path': 'meta/%s_2.txt',
                                            'img_size': [342, 342, 3],
