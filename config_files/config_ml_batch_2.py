...
def load_parameters():
    ...
    ALL_MODELS = [
                        ...
                        {
                        # Model params
                        'MODEL_TYPE': 'InceptionResNetV2_PlusFC', # see predefined models in models.py
                        'MODEL_NAME': 'Food_MultiLabel',
                        'STORE_PATH': '%s/food_multilabel', # insert MODELS_ROOT_PATH in %s
